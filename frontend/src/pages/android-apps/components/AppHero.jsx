      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-32">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm rounded-full mb-6 md:mb-8">
            ...
            <span className="text-sm md:text-base font-medium">Android Apps</span>
          </div>
          ...
          <p className="text-base md:text-lg lg:text-xl text-white/90 mb-8 md:mb-10 leading-relaxed max-w-3xl mx-auto">
            Native Android companion apps for our software suite. Browse app details, screenshots, and get the app on your device.
          </p>

          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <div className="flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-white/10 backdrop-blur-sm rounded-lg">
              <Icon name="ShieldCheck" size={20} className="text-[var(--color-brand-success)]" />
              <span className="text-sm md:text-base">Secure & Regularly Updated</span>
            </div>
            <div className="flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 bg-white/10 backdrop-blur-sm rounded-lg">
              <Icon name="Download" size={20} className="text-[var(--color-brand-success)]" />
              <span className="text-sm md:text-base">Play Store & Direct APK</span>
            </div>
          </div>
        </div>
      </div>
